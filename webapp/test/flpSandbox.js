		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#GestionedeiProdotti-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"GestionedeiProdotti-display": {
								"semanticObject": "GestionedeiProdotti",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=products.products",
									"url": sap.ui.require.toUrl("products/products")
								}
							}
						}
					}
